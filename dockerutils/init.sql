...
ALTER TABLE ONLY "public"."passwords" ADD CONSTRAINT "passwords_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users(user_id) ON UPDATE CASCADE ON DELETE CASCADE NOT DEFERRABLE;

ALTER TABLE ONLY "public"."users" ADD CONSTRAINT "users_user_role_fkey" FOREIGN KEY (user_role) REFERENCES roles(role_id) ON UPDATE CASCADE ON DELETE SET DEFAULT NOT DEFERRABLE;
...
VALUES
    ('00000000-0000-0000-0000-000000000001', 'default', 'admin', 'default@admin.com', 1);

-- Generate passwords for users
INSERT INTO "passwords" (password_id, user_id, password)
VALUES
    ('00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000001', '$argon2id$v=19$m=65536,t=3,p=4$L1SGzOM6joPhlb8Out4dAg$exuTB0l39jlzy0m/ItJHBPI16vO6rVQCgI9ousD6lA8');
